"""Exceptions for reCAPTCHA solving."""
...
class RecaptchaRateLimitError(RecaptchaSolveError):
    ...
    def __init__(self, message: Optional[str] = None) -> None:
        super().__init__(message or "The reCAPTCHA rate limit has been exceeded.")
...
class RecaptchaTimeoutError(RecaptchaSolveError):
    ...
    def __init__(self, message: Optional[str] = None) -> None:
        super().__init__(message or "The reCAPTCHA solve timeout has been exceeded.")
