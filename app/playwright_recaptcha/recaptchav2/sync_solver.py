"""Synchronous reCAPTCHA v2 solver using token injection."""
...
class SyncSolver(BaseSolver[Page]):
    """
    A class for solving reCAPTCHA v2 synchronously using token injection.
        ...
        *,
        ...
        if wait:
            ...
            while time.time() - start_time < wait_timeout:
                iframe_count = self._page.locator('iframe[src*="recaptcha"]').count()
                if iframe_count > 0:
